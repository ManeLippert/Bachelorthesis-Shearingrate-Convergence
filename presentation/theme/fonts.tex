...
\else%
	...
	\else%
		...
		\usefonttheme[onlymath]{serif}%
	\fi%
	\newfontfamily\Light[ Path = theme/font/ ]{Flama-Light}%
	\newfontfamily\Book[ Path = theme/font/ ]{Flama-Book}%
	\newfontfamily\Medium[ Path = theme/font/ ]{Flama-Medium}%
	\setsansfont[ Path = theme/font/ ]{Flama-Light}%
\fi%
