...
\begin{document}
	...
	\begin{frame}
		...
		\includegraphics{Presentation/ITG_Instability_00.pdf}
	\end{frame}
	\begin{frame}
		\frametitle{ITG Instabilität am Plasmarand}
		\includegraphics{Presentation/ITG_Instability_01.pdf}
	\end{frame}
	\begin{frame}
		\frametitle{ITG Instabilität am Plasmarand}
		\includegraphics{Presentation/ITG_Instability_02.pdf}
	\end{frame}
	\begin{frame}
		\frametitle{ITG Instabilität am Plasmarand}
		\includegraphics{Presentation/ITG_Instability_03.pdf}
	\end{frame}
	\begin{frame}
		\frametitle{ITG Instabilität am Plasmarand}
		\includegraphics{Presentation/ITG_Instability_04.pdf}
	\end{frame}
	\begin{frame}
		\frametitle{ITG Instabilität am Plasmarand}
		\includegraphics{Presentation/ITG_Instability_05.pdf}
	\end{frame}
	\begin{frame}
		\frametitle{ITG Instabilität am Plasmarand}
		\includegraphics{Presentation/ITG_Instability_06.pdf}
	\end{frame}
	\begin{frame}
		\frametitle{ITG Instabilität am Plasmarand}
		\includegraphics{Presentation/ITG_Instability_07.pdf}
	\end{frame}
	\begin{frame}
		\frametitle{ITG Instabilität am Plasmarand}
		\includegraphics{Presentation/ITG_Instability_08.pdf}

	\end{frame}
	\begin{frame}
		\frametitle{ITG Instabilität am Plasmarand}
		\includegraphics{Presentation/ITG_Instability_09.pdf}
	\end{frame}
	\begin{frame}
		\frametitle{ITG Instabilität am Plasmarand}
		\includegraphics{Presentation/ITG_Instability_10.pdf}
	\end{frame}
	...
	\begin{frame}
		...
		\end{minipage}
		\begin{minipage}{0.3\textwidth}
			\includegraphics[scale = 0.2]{Presentation/Magnetic_Shear_black.png}
		\end{minipage}
	\end{frame}
	...
	\begin{frame}
		...
		\begin{tabular}{c c}
			\includegraphics[scale = 0.2]{Presentation/Stablized_Plasma_Interaction.png} & \includegraphics[scale = 0.2]{Presentation/Stablized_Plasma_LongScale.png} \\
