...
\begin{document}
	...
	\frame{
    	...
    	\begin{center}
        	\movie{\includegraphics[width=\textwidth]{Zonal_Flow.PNG}}{../pictures/Presentation/video.mp4}
    	\end{center}
	}
	...
	\frame{
    	...
    	\begin{center}
        	\href{run:../pictures/Presentation/video.mp4}{\includegraphics[width=\textwidth]{Zonal_Flow.PNG}}
    	\end{center}
	}
