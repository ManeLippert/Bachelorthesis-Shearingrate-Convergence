/* Minimal UMFPACK wrapper for GKW using non-standard calls to C from Fortran */
/* $Id:$                                                                      */
/* This is a slightly modified and simplified version of the umf4_f77wrapper
   and umf4_f77zwrapper provided with UMFPACK. It should be used when the
   Fortran 2003 standard ISO_C_BINDING is not available. Note that some of the
   original comments below may not apply modern Fortran.                      */
 ...
 *
 * If you want to use 64-bit integers, try compiling this file with the -Dkernel32
...
#define UMFPACK_z_defaults	 umfpack_zl_defaults
#define UMFPACK_z_free_numeric	 umfpack_zl_free_numeric
#define UMFPACK_z_free_symbolic	 umfpack_zl_free_symbolic
#define UMFPACK_z_numeric		 umfpack_zl_numeric
#define UMFPACK_z_report_control	 umfpack_zl_report_control
#define UMFPACK_z_report_info	 umfpack_zl_report_info
#define UMFPACK_z_save_numeric	 umfpack_zl_save_numeric
#define UMFPACK_z_save_symbolic	 umfpack_zl_save_symbolic
#define UMFPACK_z_load_numeric	 umfpack_zl_load_numeric
#define UMFPACK_z_load_symbolic	 umfpack_zl_load_symbolic
#define UMFPACK_z_scale		 umfpack_zl_scale
#define UMFPACK_z_solve		 umfpack_zl_solve
#define UMFPACK_z_symbolic	 umfpack_zl_symbolic

#else

#define UMFPACK_z_defaults	 umfpack_zi_defaults
#define UMFPACK_z_free_numeric	 umfpack_zi_free_numeric
#define UMFPACK_z_free_symbolic	 umfpack_zi_free_symbolic
#define UMFPACK_z_numeric		 umfpack_zi_numeric
#define UMFPACK_z_report_control	 umfpack_zi_report_control
#define UMFPACK_z_report_info	 umfpack_zi_report_info
#define UMFPACK_z_save_numeric	 umfpack_zi_save_numeric
#define UMFPACK_z_save_symbolic	 umfpack_zi_save_symbolic
#define UMFPACK_z_load_numeric	 umfpack_zi_load_numeric
#define UMFPACK_z_load_symbolic	 umfpack_zi_load_symbolic
#define UMFPACK_z_scale		 umfpack_zi_scale
#define UMFPACK_z_solve		 umfpack_zi_solve
#define UMFPACK_z_symbolic	 umfpack_zi_symbolic
...
{
    fflush (stdout) ;
    UMFPACK_z_report_control (Control) ;
    fflush (stdout) ;
}
...
void umf4zsym_ (Int *m, Int *n, Int Ap [ ], Int Ai [ ],
    ...
    double Control [UMFPACK_CONTROL], double Info [UMFPACK_INFO])
{
    (void) UMFPACK_z_symbolic (*m, *n, Ap, Ai, Ax, Az, Symbolic, Control, Info) ;
}
...
void umf4znum_ (Int Ap [ ], Int Ai [ ], double Ax [ ], double Az [ ],
    ...
    double Control [UMFPACK_CONTROL], double Info [UMFPACK_INFO])
{
    (void) UMFPACK_z_numeric (Ap, Ai, Ax, Az, *Symbolic, Numeric, Control, Info);
}
...
void umf4zsolr_ (Int *sys, Int Ap [ ], Int Ai [ ], double Ax [ ], double Az [ ],
    ...
    double Control [UMFPACK_CONTROL], double Info [UMFPACK_INFO])
{
    (void) UMFPACK_z_solve (*sys, Ap, Ai, Ax, Az, x, xz, b, bz,
...
{
    Control [UMFPACK_IRSTEP] = 0 ;
    (void) UMFPACK_z_solve (*sys, (Int *) NULL, (Int *) NULL, (double *) NULL,
...
{
    *status = UMFPACK_z_scale (x, xz, b, bz, *Numeric) ;
}
...
{
    fflush (stdout) ;
    UMFPACK_z_report_info (Control, Info) ;
    fflush (stdout) ;
}
...
{
    UMFPACK_z_free_numeric (Numeric) ;
}
...
{
    UMFPACK_z_free_symbolic (Symbolic) ;
}
...
void umf4zsnum_ (void **Numeric, Int *filenum, Int *status)
{
    char filename [LEN] ;
    make_filename (*filenum, "n", filename) ;
    *status = UMFPACK_z_save_numeric (*Numeric, filename) ;
}
...
void umf4zssym_ (void **Symbolic, Int *filenum, Int *status)
{
    char filename [LEN] ;
    make_filename (*filenum, "s", filename) ;
    *status = UMFPACK_z_save_symbolic (*Symbolic, filename) ;
}
...
void umf4zlnum_ (void **Numeric, Int *filenum, Int *status)
{
    char filename [LEN] ;
    make_filename (*filenum, "n", filename) ;
    *status = UMFPACK_z_load_numeric (Numeric, filename) ;
}
...
void umf4zlsym_ (void **Symbolic, Int *filenum, Int *status)
{
    char filename [LEN] ;
    make_filename (*filenum, "s", filename) ;
    *status = UMFPACK_z_load_symbolic (Symbolic, filename) ;
}
