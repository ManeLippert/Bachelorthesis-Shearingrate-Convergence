...
%
% Usage: growth_rates(proj,,file,variable,n_av)
%
...
%
% Example: growth_rates('latest_project','runs*','ROTATION.shear_rate',100)
%
% This script interfaces with Yann's scripts 
% It requires gkw_path to be set up correctly for your projects directory.

function [growth_rat]=growth_rates(proj,filename,variable,n_av)
