...
Together with the results of Chapter \ref{sub:reduceNvpar}, \ref{sub:reduceNmu} and \ref{sub:reduceNs} the final resolution used in the upcoming simulations is displayed in Table \ref{tab:resolution}, with reduced number of grid points for the parallel velocity $\Nvpar$.
\begin{center}
