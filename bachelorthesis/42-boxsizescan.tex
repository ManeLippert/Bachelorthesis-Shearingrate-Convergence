...
This chapter is an further iteration of the brief communication published in \enquote{Physics of Plasma}. It provides additional plots and paragraphs that were not necessary for the publication. the format was changed as well because the publication was written in REV\TeX~4.1 and this bachelor thesis in \texttt{scrreprt}. The brief communication can be found in Appendix \ref{append:paper} or under Ref. \citenum{Lippert2023}.
%TODO
