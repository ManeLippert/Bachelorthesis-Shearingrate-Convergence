...
\includegraphicsHere{Theory/Tokamak-Torus.pdf}{
	Toroidal flux surfaces in tokamak plasma with helical magnetic field (\textcolor{Ubtgreen}{green} line) in torus coordinates ($\rho$ (radial), $\phi$ (toroidal), $\theta$ (poloidal)) or zylinder coordinates ($Z$, $R$, $\phi$). \cite{Barton2015}
}{fig:confinement}{0.7}