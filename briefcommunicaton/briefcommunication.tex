...
Based on the defintions above, the shear carried by the zonal flow mode with wave vector $k_j$ is defined by $|\widehat{\omega}_{\mathrm{\:E\times B}}|_{k_\mathrm{j}} = 2 |\hat \omega_{\mathrm{\:E \times B}}|$. 
