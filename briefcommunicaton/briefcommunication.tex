...
\includegraphicsTwoCol{{Comparison/Boxsize/S6_rlt6.0_boxsize1-2-3-4x1-1.5-2-2.5-3-5_Ns16_Nvpar48_Nmu9_wexb_comparison}.pdf}{
	...
	\begin{tabular}{l l l l l l l l l}
		...
		\textbf{(c) binormal:}  & $t_{3\times 1.5}$ & $\in [11000, 12000]$, & $t_{3\times 2.5}$ & $\in [2000, 3000]$,   & $t_{3\times 5}$ & $\in [2000, 4000]$    &                 &                      \\
	\end{tabular}
...
Also, this test confirms the statistical soundness of the converged pattern wavelength of $\sim ???$.\bigskip
